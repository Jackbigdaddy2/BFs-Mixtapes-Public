...
// 		trace("Line 96");
// 		// Ultrawide Adjusted
// 		// grpWeekCharacters.add(new MenuCharacter(75, 100, 0.5, false));
// 		// grpWeekCharacters.add(new MenuCharacter(663, 25, 0.9, true));
// 		// grpWeekCharacters.add(new MenuCharacter(1250, 100, 0.5, true));
// 		// Ultrawide Shifted
// 		#if Ultrawide
// 		grpWeekCharacters.add(new MenuCharacter(0 + 220, 100, 0.5, false));
// 		grpWeekCharacters.add(new MenuCharacter(450 + 220, 25, 0.9, true));
// 		grpWeekCharacters.add(new MenuCharacter(850 + 220, 100, 0.5, true));
// 		#else
